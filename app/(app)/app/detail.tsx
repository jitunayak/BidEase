    ...
    >
      <View style={{ flex: 1 }}>
        ...
        <HStack
          ...
          style={{ paddingTop: 8, paddingLeft: 12, gap: 8 }}
        >
        ...
        <View
          style={{ padding: 12, gap: 12, backgroundColor: Colors.background }}
        >
          ...
          <Text style={{ color: Colors.secondary, fontSize: 14 }}>
            ...
            parts, recently serviced with full documentation. Features a
            pristine dial, original movement, and comes with box and papers.
          </Text>
          ...
          >
            <View style={{ width: "100%", marginTop: 16, padding: 8 }}>
